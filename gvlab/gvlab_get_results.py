...
def main():
    ...
    for id, df_by_id in df_by_id:
        user1_preds = df_by_id['user_predictions'].iloc[0]
        user2_preds = df_by_id['user_predictions'].iloc[1]
        jaccard = len(user1_preds.intersection(user2_preds)) / len(user1_preds.union(user2_preds))
