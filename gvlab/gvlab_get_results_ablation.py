...
if __name__ == '__main__':
    ...
    # hit_type_id = '33KTOXRB2MHEDTK23QD1IIHZSACFRH'  # create random 10-12, 100-250 , real
    # hit_type_id = '3ARIN4O78G41KUHJD3JTIME4V1DIFY'  # solve create random 10-12, 100-250 , sandbox
    # hit_type_id = '359956SLTZK0DLUYP1GZDVMJP6XRLX'  # solve create random 10-12, 100-250 , real
    hit_type_id = '3PCDMC3F65NE9VU2OU4N1D7UAAEX2V'  # nr
